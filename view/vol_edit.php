...
<div id="event_container">
	...
	<div id="task_sign_up_fields">
		<form action=".?e=<?php echo $event_id;?>" method="POST">
			...
			<?php else: ?>
				<div class="form_text_field sign_up_field link_button"><?php if(isset($data['email'])) echo sanitizeHTML($data['email']); ?></div>
			<?php endif; ?>
			...
			<a class="button submit_button sign_up_field link_button" href=".?e=<?php echo $event_id; ?>">Cancel</a>
		</form>
	</div>
</div>