...
<div id="event_container">
	...
	<div id="task_sign_up_fields">
		<form action="." method="POST">
			...
			<textarea class="form_text_field sign_up_field" type="text" name="comment" rows="4" placeholder="Comment"><?php if(isset($comment)) echo sanitizeHTML($comment); ?></textarea>
			<?php endif; ?>
			<br />
