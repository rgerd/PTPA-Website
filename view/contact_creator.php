...
<div id="event_container">
	...
	<div id="task_sign_up_desc">To send questions or comments to the creator of this event, you may type your message below and click send.</div>
	<br />
	<form action=".?e=<?php echo $event_id; ?>" method="POST">
		...
		<textarea class="form_text_field sign_up_field" type="text" name="comment" rows="4" placeholder="Message"><?php if(isset($data['comment'])) echo sanitizeTXT($data['comment']); ?></textarea>
		<br />
