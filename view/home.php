...
<div id="home">
	...
	<table id="events_table">
		<tbody>
			...
			?>
				<tr class="event">
						<td class="event_title"><a class="hover_link" href=".?e=<?php echo $event['ID']; ?>"><?php echo sanitizeHTML($event['title']); ?></a></td>
						<td class="event_description"><a class="hover_link" href=".?e=<?php echo $event['ID']; ?>"><?php echo sanitizeHTML(removeAllNewLines($event['description'], true)); ?></a></td>
